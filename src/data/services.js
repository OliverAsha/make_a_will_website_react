export const serviceContent = {
  'how-solicitor-checked-online-will-works': {
    title: 'How Our Solicitor-Checked Wills Work',
    ...
    content: `
      <blockquote style="border-left:3px solid #6b7280;padding:8px 16px;margin:24px 0;font-style:italic;color:#374151;background:#f9fafb">
        <p style="margin:0 0 8px">"When I founded Make a Will in 2008, my goal was simple: every family in England and Wales should be able to get a properly checked will without booking a high-street appointment. To this day, every will our software produces is read and reviewed by a qualified solicitor &mdash; me or someone on my team &mdash; before you sign it."</p>
        <p style="font-style:normal;color:#6b7280;font-size:0.95rem;margin:0">&mdash; Oliver Asha, Solicitor &amp; TEP, Founder of Make a Will</p>
      </blockquote>

      <p>Most online wills services are pure software. You answer questions, the system produces a document, you sign it. There is no human review. That's the trade-off you accept for the lower price.</p>

      <p>That's not how Make a Will works. Every will our software produces is sent immediately to our solicitor team for a substantive review &mdash; not just a glance for typos, but a proper read of whether the will <em>does what you intended</em>.</p>

      <p>If we spot something that could cause problems later, we get in touch. Before your will is final.</p>

      <h2>The four steps of every will</h2>

      <h3>1. You complete the questionnaire</h3>
      <p>You answer a series of plain-English questions about your assets, your family, and your wishes. Our software builds your will using clauses and precedents drafted and maintained by our solicitor team &mdash; the same kind of language used in a will drafted in person at a high-street firm.</p>

      <h3>2. Your will is generated and delivered immediately</h3>
      <p>The moment you finish the questionnaire, your draft will is emailed to you. You don't have to wait days to see what it looks like.</p>

      <h3>3. A solicitor reviews your will (within 2 working days)</h3>
      <p>At the same moment your will is sent to you, a copy is sent to our solicitor team. A qualified solicitor reads it carefully and considers, in particular:</p>
      <ul>
        <li>Whether your gifts are clearly worded and unambiguous</li>
        <li>Whether your <a href="/resource/executors">executors</a> and substitutes are sensibly chosen and properly empowered</li>
        <li>Whether your <a href="/resource/legal-guardians">guardianship arrangements</a> (if you have minor children) are watertight</li>
        <li>Whether anything in your circumstances suggests you would benefit from more specialist advice &mdash; for example, complex business interests, foreign property, inheritance tax planning, or trusts arising from a second marriage with children from a previous relationship</li>
      </ul>
      <p>If anything raises a concern, we contact you with our feedback within those two working days.</p>

      <h3>4. You make any amendments &mdash; and we re-check</h3>
      <p>You have 28 days from completion to consider our feedback, make any amendments, and generate a fresh set of documents. (If you have purchased our Print &amp; Send service, you have 5 days from completion before your documents are printed and posted to you.)</p>
      <p>Any updated will goes through the same review. Same team, same checks. There is no additional charge.</p>

      <h2>What we tell you if we spot a concern</h2>
      <p>We don't make changes to your will without your say-so. Our role is to flag, advise, and leave the decision with you. The most common things we raise:</p>
      <ul>
        <li><strong>Ambiguous gifts</strong> &mdash; "I leave my watch to my daughter" when you have two daughters, or "I leave my car to John" when the car you own at the time of your death may not be the same one you owned when you wrote the will.</li>
        <li><strong>Missing substitutes</strong> &mdash; what should happen if your chosen executor or beneficiary dies before you do?</li>
        <li><strong>Specialist circumstances</strong> &mdash; if you own a business, hold property abroad, have an estate where <a href="/resource/inheritance-tax-guide">inheritance tax planning</a> could be valuable, have vulnerable beneficiaries, or are in a second marriage with children from a previous relationship, we may recommend you take advice from a specialist before signing.</li>
      </ul>
      <p>In every case, we explain what we have spotted and why we think it is worth your attention &mdash; in plain English, no legal jargon &mdash; and you decide what to do next.</p>
      ...
      <p><strong>Oliver Asha</strong> &mdash; Solicitor (England &amp; Wales, SRA 372772) and Trust and Estate Practitioner (TEP) &mdash; founded Make a Will in 2008. Oliver leads our solicitor review team. All of our reviewing solicitors are qualified in England and Wales and regulated by the Solicitors Regulation Authority.</p>
      <p>Verify Oliver's credentials: <a href="https://solicitors.lawsociety.org.uk/person/159165/oliver-asha" target="_blank" rel="noopener noreferrer">Law Society</a> &middot; <a href="https://www.sra.org.uk/consumers/register/person/?sraNumber=372772" target="_blank" rel="noopener noreferrer">SRA register</a> &middot; <a href="https://www.step.org/directory/members/mr-oliver-asha-0033c00002wbj1maab" target="_blank" rel="noopener noreferrer">STEP directory</a></p>

      <h2>Start your solicitor-checked will</h2>
      <p>Single will &pound;90 &middot; Mirror wills (for couples) &pound;135. Every will reviewed by a solicitor within 2 working days. 30-day money-back guarantee.</p>
      <p><a href="/start-your-will" class="btn btn-primary">make my will</a></p>
    `
  },
  'lifetime-updates': {

export const resourceContent = {
  ...
  'how-solicitor-checked-online-will-works': {
    ...
    content: `
      <blockquote>
        <p><em>"When I founded Make a Will in 2008, my goal was simple: every family in England and Wales should be able to get a properly checked will without booking a high-street appointment. To this day, every will our software produces is read and reviewed by a qualified solicitor &mdash; me or someone on my team &mdash; before you sign it."</em></p>
        <p>&mdash; Oliver Asha, Solicitor &amp; TEP, Founder of Make a Will</p>
      </blockquote>
